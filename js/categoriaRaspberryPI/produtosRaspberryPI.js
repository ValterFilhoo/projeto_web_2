document.addEventListener('DOMContentLoaded', function() {
    ...
    // Faz uma requisição para buscar produtos da categoria "RaspberryPI" no servidor.
    fetch('../PHP/buscarProdutos/buscarProdutosCategoria.php?categoria=RaspberryPI')
        .then(resposta => {
